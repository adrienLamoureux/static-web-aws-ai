...
const authenticatedChecks = [
  {
    ...
    path: "/",
    expectPath: "/",
    expectedAnyTexts: ["Whisk Studio", "Forge", "Storyboard"],
  },
  {
    id: "forge-page",
    path: "/forge",
    expectPath: "/forge",
    expectedAnyTexts: ["Forge", "Images", "Videos"],
  },
  {
    id: "storyboard-page",
    path: "/storyboard",
    expectPath: "/storyboard",
    expectedAnyTexts: ["Storyboard", "Story", "New Session"],
  },
  {
    id: "showcase-page",
    path: "/showcase",
    expectPath: "/showcase",
    expectedAnyTexts: ["Showcase", "Shared", "Gallery"],
  },
  {
    id: "director-page",
    path: "/director",
  ...
  {
    id: "director-sounds-page",
    path: "/director/sounds",
    expectPath: "/director/sounds",
    expectedTexts: ["Upload and categorize soundtracks"],
  },
  {
    id: "director-lora-page",
    path: "/director/lora",
    expectPath: "/director/lora",
  ...
  {
    id: "lora-redirect-page",
    path: "/lora",
    expectPath: "/director/lora",
    expectedAnyTexts: ["LoRA Catalog", "Character LoRA Profile"],
  },
  {
    id: "videos-redirect-page",
    path: "/videos",
    expectPath: "/forge",
    expectedAnyTexts: ["Forge", "Images", "Videos"],
  },
  {
    id: "story-redirect-page",
    path: "/story",
    expectPath: "/storyboard",
    expectedAnyTexts: ["Storyboard", "Story", "New Session"],
  },
  {
    id: "music-library-redirect-page",
    path: "/music-library",
    expectPath: "/director/sounds",
    expectedTexts: ["Upload and categorize soundtracks"],
  },
