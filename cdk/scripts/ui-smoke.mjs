...
/* ─── Kitsune route model ───
   Primary: /, /studio, /stories, /browse, /admin, /admin/sounds, /admin/lora, /about
...
const unauthenticatedChecks = [
  ...
  { id: "studio-redirect", path: "/studio", expectLogin: true, expectPath: "/login" },
  ...
  { id: "admin-redirect", path: "/admin", expectLogin: true, expectPath: "/login" },
...
const authenticatedChecks = [
  {
    ...
    path: "/",
    expectPath: "/",
    expectedAnyTexts: ["Home", "Your creative dashboard", "Whisk Studio"],
  },
  {
    id: "studio-page",
    path: "/studio",
    expectPath: "/studio",
    expectedAnyTexts: ["Studio", "Generate images"],
  },
  {
    id: "stories-page",
    path: "/stories",
    expectPath: "/stories",
    expectedAnyTexts: ["Stories", "Storytelling", "Story Teller", "Storybook"],
  },
  {
    id: "browse-page",
    path: "/browse",
    expectPath: "/browse",
    expectedAnyTexts: ["Browse", "Gallery", "Shared Images"],
  },
  {
    id: "admin-page",
    path: "/admin",
    expectPath: "/admin",
    expectedAnyTexts: ["Admin Dashboard", "Admin", "Command Center"],
  },
  {
    id: "sounds-page",
    path: "/admin/sounds",
    expectPath: "/admin/sounds",
    expectedAnyTexts: ["Sound Vault", "Upload and categorize", "Music Library"],
  },
  {
    id: "lora-page",
    path: "/admin/lora",
    expectPath: "/admin/lora",
    expectedAnyTexts: ["LoRA", "Character LoRA"],
  },
  {
    id: "about-page",
    path: "/about",
  ...
  /* Legacy redirects */
  {
    ...
    path: "/forge",
    expectPath: "/studio",
    expectedAnyTexts: ["Studio"],
  },
  {
    id: "legacy-story",
    path: "/story",
    expectPath: "/stories",
    expectedAnyTexts: ["Stories", "Storytelling"],
  },
  {
    id: "legacy-shared",
    path: "/shared",
    expectPath: "/browse",
    expectedAnyTexts: ["Browse", "Gallery"],
  },
  {
    id: "legacy-director",
    path: "/director",
    expectPath: "/admin",
    expectedAnyTexts: ["Admin"],
  },
];
