  ...
  return (
    <div style={{ marginTop: 28 }}>
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 12, color: "var(--skr-text-tertiary)", margin: "3px 0 0" }}>
            {isLoading
              ? "Loading…"
              : `${images.length} portrait${images.length !== 1 ? "s" : ""} — shown on the home page hero`}
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        >
          No portraits uploaded yet. Upload portrait images (3:5 aspect ratio works best) to
          populate the animated home page hero.
        </div>
      ) : (
