  ...
  return (
    <div>
      <div className="sol-page-header">
        <h2 className="sol-page-title">Forge</h2>
        <p className="sol-page-subtitle">Generate images and animate videos</p>
      </div>
      <div className="sol-tab-bar">
        <button
          type="button"
          className={`sol-tab${tab === 'images' ? ' is-active' : ''}`}
        ...
        <button
          type="button"
          className={`sol-tab${tab === 'videos' ? ' is-active' : ''}`}
