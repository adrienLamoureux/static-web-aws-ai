  ...
  return (
    <>
      ...
      >
        {showCta && (
          <div
            className="skr-image-tile skr-image-tile-cta"
            role="button"
            tabIndex={0}
            onClick={onCta}
            onKeyDown={(event) => {
          ...
          >
            <span className="skr-image-tile-plus">+</span>
          </div>
        )}
        {images.length > 0 ? (
          images.map((image, index) => (
            ...
            >
              <span className="skr-image-tile-media">
                <img
                  className="skr-image-tile-backdrop"
                  src={image.url}
                  alt=""
                  aria-hidden="true"
                />
                <img
                  className="skr-image-tile-main"
                  src={image.url}
                  alt={image.key || "Generated image"}
                />
              </span>
              <div className="skr-image-tile-overlay" />
              <span className="skr-image-tile-caption">{toDisplayLabel(image, index)}</span>
              <span className="skr-image-tile-actions">
                {onOpenVideo && (
                  <button
                    type="button"
                ...
                <button
                  type="button"
                  className={`skr-icon-btn${image.favorite ? " is-favorite" : ""}`}
                  onClick={(event) => {
                    event.stopPropagation();
