...
export const REACTIONS = {
  ...
  [CompanionActions.FIRST_VISIT]:      { motion: "greet",       emotion: "happy"     },
  [CompanionActions.LONG_SESSION]:     { motion: "acknowledge", emotion: "happy"     },
  [CompanionActions.STORY_TURN]:       { motion: "react",       emotion: "surprised" },
};
